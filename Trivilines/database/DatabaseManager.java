...
/**
 * Utilidad general para operaciones con la base de datos:
 * - Inicializar el esquema (schema.sql).
 * - Ejecutar consultas y actualizaciones con parámetros.
 */
public final class DatabaseManager {

    private static final String RUTA_SCHEMA = "resources/database/scripts/schema.sql";
     ...
     *
     * IMPORTANTE: el llamador debe cerrar el ResultSet, el PreparedStatement
     * y la Connection cuando termine de usarlo.
     *
     * Para simplificar, aquí devolvemos solo el ResultSet y dejamos al
     * repositorio que gestione el cierre (o use try-with-resources).
     */
    ...
    /**
     * Cierra cualquier recurso AutoCloseable sin lanzar excepción.
     * Útil para cerrar ResultSet, PreparedStatement, etc.
     */
