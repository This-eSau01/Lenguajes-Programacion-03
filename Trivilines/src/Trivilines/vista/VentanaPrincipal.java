...
import Trivilines.util.ColoresUI;     // ← Importamos la paleta de colores
...
public class VentanaPrincipal extends JFrame {
    ...
    private void inicializar() {
        ...
        // Fondo general de la ventana usando ColoresUI
        getContentPane().setBackground(ColoresUI.FONDO_GENERAL);

        cardLayout = new CardLayout();
        panelCentral = new JPanel(cardLayout);
        panelCentral.setOpaque(true);
        panelCentral.setBackground(ColoresUI.FONDO_PANEL); // color base para el área central
